...
class Queue():
    ...
    def swap_to_front(self, new_head):
        old_next = self._head.next
        self._head = Node(new_head, old_next)



my_jobs = ['Landscaper', 'Sweeper', 'GA Assistant', 'Runner', 'Software Engineer']
...
list = add_jobs(my_jobs)

print(list)

print(list.swap_to_front('Landscaper'))
